/** biome-ignore-all lint/correctness/useExhaustiveDependencies: Animation timing intentionally reacts only to its configured triggers. */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: Animated character positions have no stable semantic identifier. */
"use client";
