...
type BorderGlowProps = {
  ...
  colors?: string[];
  fillOpacity?: number;
  fillBlendMode?: CSSProperties["mixBlendMode"];
  edgeBlendMode?: CSSProperties["mixBlendMode"];
  lightBackgroundColor?: string;
  lightBorderColor?: string;
  lightColors?: string[];
  lightEdgeBlendMode?: string;
  lightFillBlendMode?: string;
  lightFillOpacity?: number;
  lightGlowColor?: string;
  lightGlowIntensity?: number;
  lightShadow?: string;
};
