...
type ThreadsProps = Omit<ComponentPropsWithoutRef<"div">, "color"> & {
  color?: RgbColor;
  lightColor?: RgbColor;
  amplitude?: number;
  distance?: number;
...
const DARK_THEME_THREADS_COLOR: RgbColor = [1, 11, 110];
const LIGHT_THEME_THREADS_COLOR: RgbColor = [0, 0.32, 0.36];
...
function getThemeAwareColor(color: RgbColor, lightColor: RgbColor): RgbColor {
...
const Threads = ({
  ...
  const propsRef = useRef<ThreadUniformProps>({
